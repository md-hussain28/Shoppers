...
const Hero = () => {
  return (
    <div className='min-h-screen h-fit flex flex-col sm:flex-row justify-around items-center bg-gradient-to-b from-pink-300 to-lime-50'>
      ...
      <div className='flex flex-col justify-center'>
        <img className='w-4/5 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl object-contain' src={images.hero_image} alt="hero_image" />
      </div>
    </div>
  )
}
